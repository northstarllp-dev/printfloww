...
CREATE TABLE "file_options" (
	...
	CONSTRAINT "file_options_file_id_unique" UNIQUE("file_id")
);
--> statement-breakpoint
CREATE TABLE "files" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE "orders" (
	...
	"tracking_token_prefix" text DEFAULT '' NOT NULL,
...
ALTER TABLE "file_options" ADD CONSTRAINT "file_options_file_id_files_id_fk" FOREIGN KEY ("file_id") REFERENCES "public"."files"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
